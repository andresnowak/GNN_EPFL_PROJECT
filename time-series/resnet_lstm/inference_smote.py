...
def main(config, model_path):
    ...
    submission_df.to_csv(
        f"{dir}/submission_smote_{datetime.now().strftime('%Y%m%d')}.csv", index=False
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", required=True, help="Path to model", default="wandb/run-20250527_113402-mlucpshg/files/best_smote_model.pth")
