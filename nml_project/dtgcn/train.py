...
def main(config: dict):
    ...
    if log_wandb:
        ...
        save_config(config, wandb_dir, "dtgcn.yaml")
    else:
        save_config(config, output_dir, "dtgcn.yaml")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', required=False, help="Path to yaml config file", default=os.path.join(script_dir, "configs/dtgcn.yaml"))
