...
from models import get_normalized_adj, STGCNClassifier_2
...
def main(config: dict):
    ...
    if log_wandb:
        ...
        save_config(config, wandb_dir, "stgcn_2.yaml")
    else:
        save_config(config, output_dir, "stgcn_2.yaml")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", required=False, help="Path to yaml config file", default=os.path.join(script_dir, "configs/stgcn_2.yaml"))
