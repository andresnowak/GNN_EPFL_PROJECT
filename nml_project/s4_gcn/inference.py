...
parser = argparse.ArgumentParser(description="Run inference on the S4-GCN model.")
...
model = S4_GCN(s4_hidden_dim, s4_dropout, gcn_hidden, gcn_out, gcn_dropout).to(device)
